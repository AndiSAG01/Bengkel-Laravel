                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <select wire:model="member_id" class="form-select shadow-sm">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" wire:model="plat_nomor" class="form-control shadow-sm"
                                    placeholder="Contoh: B 1234 AB">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label">Jenis Kendaraan</label>
                                <select wire:model="jenis_kendaraan" class="form-select shadow-sm">
                    ...
                    <div class="card-body">
                        <div class="row g-3 align-items-end">
                            <div class="col-md-2">
                                ...
                                <select wire:model.live="jenis_transaksi" class="form-select shadow-sm">
                            ...
                            <div class="col-md-6">
                                ...
                                @if ($jenis_transaksi === 'Produk')
                                    <select wire:model="product_id" class="form-select shadow-sm">
                                ...
                                @elseif($jenis_transaksi === 'Service')
                                    <select wire:model="service_id" class="form-select shadow-sm">
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="number" wire:model="qty" class="form-control shadow-sm" min="1">
                            </div>
